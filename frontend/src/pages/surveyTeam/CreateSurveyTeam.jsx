    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        if (isEditMode) {
          ...
          addToast('Survey Team Updated Successfully!', 'success');
        } else {
      ...
      <div className="relative z-10 px-6 md:px-12 mx-auto pb-20 pt-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-black uppercase rim-light tracking-tighter">
            {isEditMode ? 'Edit' : 'Create'} <span className="text-solar-yellow">Survey Team</span>
          </h1>
        </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/10 flex justify-between items-center">
                ...
                <div className="flex gap-4 ml-auto">
                  ...
                  {activeTab !== 'members' ? (
                    ...
                    >
                      {loading ? 'Saving...' : (isEditMode ? 'Update Team' : 'Create Team')} <CheckCircle2 className="w-4 h-4 ml-2" />
                    </Button>
                  )}
                </div>
              </div>
