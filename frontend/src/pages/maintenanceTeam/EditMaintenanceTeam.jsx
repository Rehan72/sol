                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormField name="teamName" label="Team Name" required touched={touched} errors={errors}>
                                <div className="relative">
                                    ...
                                    <input type="text" name="teamName" value={formData.teamName} onChange={handleChange} placeholder="e.g., FixIt Fast" className={getInputClassName('teamName', touched, errors)} />
                                </div>
                            </FormField>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-xs font-medium uppercase tracking-wider text-white/50 bg-white/10 px-2 py-0.5 rounded-full inline-flex items-center gap-1">
                                                        <Tag className="w-3 h-3" /> {MAINTENANCE_ROLES.find(r => r.value === member.role)?.label}
                                                    </span>
                                                </div>
                                            </div>
                                            <Button
